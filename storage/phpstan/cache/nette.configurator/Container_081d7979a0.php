...
class Container_081d7979a0 extends _PHPStan_f1e88529a\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0365(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_081d7979a0 $container)
			{
	...
	public function createServiceContainer(): Container_081d7979a0
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'APP_URL' => 'http://ny-times-best-sellers.test',
				...
				'DB_DATABASE' => 'ny-times-best-sellers',
				'HERD_PHP_84_INI_SCAN_DIR' => '/Users/kevindavis/Library/Application Support/Herd/config/php/84/',
				'REDIS_PASSWORD' => 'null',
				'_' => '/Users/kevindavis/Library/Application Support/Herd/bin/php84',
				...
				'LANG' => 'C.UTF-8',
				'P9K_TTY' => 'old',
				'NY_TIMES_API_KEY' => 'Z8zTmZA5G2BLEVBc9lan7GRXUa1ZxAfNu9CdIcUcqJCWrHnW',
				'SESSION_PATH' => '/',
				'XPC_FLAGS' => '0x0',
				'VSCODE_GIT_ASKPASS_EXTRA_ARGS' => '',
				'NY_TIMES_BOOKS_URL' => 'https://api.nytimes.com',
				'APP_DEBUG' => 'true',
				'APP_KEY' => 'base64:QHMWV856KmjR8TytF7zLawA04L2zz6In7SyvDlTi4fY=',
				'LINES' => '15',
				'XPC_SERVICE_NAME' => '0',
				'AWS_ACCESS_KEY_ID' => '',
				'VSCODE_INJECTION' => '1',
