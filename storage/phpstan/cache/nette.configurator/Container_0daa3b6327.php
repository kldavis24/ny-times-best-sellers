...
class Container_0daa3b6327 extends _PHPStan_f1e88529a\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0365(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_0daa3b6327 $container)
			{
	...
	public function createServiceContainer(): Container_0daa3b6327
	{
		return $this;
	}
