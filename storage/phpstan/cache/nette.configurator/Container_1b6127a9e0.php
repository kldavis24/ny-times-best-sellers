...
class Container_1b6127a9e0 extends _PHPStan_f1e88529a\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0365(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_1b6127a9e0 $container)
			{
	...
	public function createServiceContainer(): Container_1b6127a9e0
	{
		return $this;
	}
