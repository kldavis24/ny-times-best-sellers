...
class Container_2fcdad7b76 extends _PHPStan_f1e88529a\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0365(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_2fcdad7b76 $container)
			{
	...
	public function createServiceContainer(): Container_2fcdad7b76
	{
		return $this;
	}
