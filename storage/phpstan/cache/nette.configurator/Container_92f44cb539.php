...
class Container_92f44cb539 extends _PHPStan_f1e88529a\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0365(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_92f44cb539 $container)
			{
	...
	public function createServiceContainer(): Container_92f44cb539
	{
		return $this;
	}
