...
class Container_9fb8a23d7b extends _PHPStan_f1e88529a\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0365(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_9fb8a23d7b $container)
			{
	...
	public function createServiceContainer(): Container_9fb8a23d7b
	{
		return $this;
	}
