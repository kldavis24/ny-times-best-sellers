...
class Container_bd4de71d1f extends _PHPStan_f1e88529a\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0365(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_bd4de71d1f $container)
			{
	...
	public function createServiceContainer(): Container_bd4de71d1f
	{
		return $this;
	}
