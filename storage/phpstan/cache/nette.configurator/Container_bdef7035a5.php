...
class Container_bdef7035a5 extends _PHPStan_f1e88529a\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0365(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_bdef7035a5 $container)
			{
	...
	public function createServiceContainer(): Container_bdef7035a5
	{
		return $this;
	}
