...
class Container_ee76e8ab08 extends _PHPStan_f1e88529a\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0365(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_ee76e8ab08 $container)
			{
	...
	public function createServiceContainer(): Container_ee76e8ab08
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'VSCODE_NONCE' => '374c7c58-bee7-45f4-8c07-5a9a8ff5b708',
				'P9K_SSH' => '0',
				'P9K_TTY' => 'old',
				'LANG' => 'C.UTF-8',
