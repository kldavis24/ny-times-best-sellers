...
class Container_ff8103b21d extends _PHPStan_f1e88529a\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0365(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_ff8103b21d $container)
			{
	...
	public function createServiceContainer(): Container_ff8103b21d
	{
		return $this;
	}
